...
//    }
    ...
    public void editBarang(){
        ...
        String sql = "UPDATE data_barang SET nama='"+nama+"', jumlah='"+jumlah+"', kategori='"+kategori+"' WHERE id='"+kode+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet barang = stat.executeQuery(dataBarang);
            while(barang.next()){
                String barang_id = barang.getString("id");dispose();
                    try{
                        stat.executeUpdate(sql);
                        JOptionPane.showMessageDialog(null, "Berhasil Mengubah "+nama+"!");
                        dispose();
                    } catch(Exception err){
    ...
    public void detail(String kode, String nama, String jumlah ){
     ...
     */
    public EditData(String kode, String nama, String jumlah) {
        initComponents();
        dataKategori();
        inputkode.setEditable(false);
        detail(kode, nama, jumlah);
    }
